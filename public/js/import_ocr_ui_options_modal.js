  ...
  function createImportOcrUiOptionsModal({ refs, state, t, msg, shared, resolvePreferredOcrLanguage }) {
    ...
    const PREPROCESS_OPERATION_UI = Object.freeze({
      ...
      local_illumination_correction: Object.freeze({
        modeSelect: ocrPreprocessModeLocalIlluminationCorrection,
        manualContainer: ocrPreprocessManualLocalIlluminationCorrection,
        manualFields: Object.freeze({
          windowPx: ocrPreprocessLocalIlluminationWindowInput,
          offsetPct: ocrPreprocessLocalIlluminationOffsetInput,
        }),
      }),
      adaptive_contrast: Object.freeze({
        modeSelect: ocrPreprocessModeAdaptiveContrast,
        manualContainer: ocrPreprocessManualAdaptiveContrast,
        manualFields: Object.freeze({
          tilePct: ocrPreprocessAdaptiveContrastTileInput,
          clipLimit: ocrPreprocessAdaptiveContrastClipInput,
          bins: ocrPreprocessAdaptiveContrastBinsInput,
        }),
      }),
      ...
      text_sharpen: Object.freeze({
        modeSelect: ocrPreprocessModeTextSharpen,
        manualContainer: ocrPreprocessManualTextSharpen,
        manualFields: Object.freeze({
          radiusPx: ocrPreprocessTextSharpenRadiusInput,
          sigmaPx: ocrPreprocessTextSharpenSigmaInput,
          amount: ocrPreprocessTextSharpenAmountInput,
          threshold: ocrPreprocessTextSharpenThresholdInput,
        }),
      }),
      ...
      page_cleanup: Object.freeze({
        ...
        manualFields: Object.freeze({
          maskScanSize: ocrPreprocessPageCleanupMaskScanSizeInput,
          grayfilterSize: ocrPreprocessPageCleanupGrayfilterSizeInput,
          noisefilterIntensity: ocrPreprocessPageCleanupNoisefilterIntensityInput,
          blackfilterIntensity: ocrPreprocessPageCleanupBlackfilterIntensityInput,
          blurfilterSize: ocrPreprocessPageCleanupBlurfilterSizeInput,
        }),
      }),
    });
