...
const IMPORT_ERROR_MESSAGE_KEYS = Object.freeze({
  ...
  OCR_PREPROCESS_UNAVAILABLE: 'renderer.alerts.import_ocr_preprocess_unavailable',
  OCR_PREPROCESS_FAILED: 'renderer.alerts.import_ocr_preprocess_failed',
  OCR_PREPROCESS_TIMEOUT: 'renderer.alerts.import_ocr_preprocess_timeout',
  OCR_PREPROCESS_CANCELED: 'renderer.alerts.import_ocr_preprocess_canceled',
