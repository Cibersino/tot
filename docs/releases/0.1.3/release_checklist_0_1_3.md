...
* [x] GitHub Issues: revisar el milestone `0.1.3`:
...
* [x] Roadmap (GitHub Project “toT Roadmap”):
  * [x] Vista por milestone: filtrar por `0.1.3` (o equivalente) y verificar consistencia con el milestone del repo.
...
* [x] `docs/changelog_detailed.md`: reflejar el release `0.1.3` con detalle.
* [x] `CHANGELOG.md`: reflejar el release `0.1.3` con resumen.
...
* [x] `package.json`: `"version": "0.1.3"` (fuente de verdad; `app.getVersion()`).
...
* [x] Commit final del release creado antes de empaquetar.
  * Commit: `c6e554c18b9bc235c56d1e659ce1ad33caef32bd`
...
* [x] Registrar identificador del artefacto final:
  * Nombre exacto: `toT-0.1.3-win-x64.zip`
...
* [x] GitHub tag del release: `v0.1.3` (prefijo `v` obligatorio) apuntando al commit del freeze.
* [x] Publicar GitHub Release `v0.1.3` (Latest si corresponde) y adjuntar el artefacto final.
* [x] Release notes: usar el resumen de `CHANGELOG.md` (y/o link explícito a `docs/changelog_detailed.md`).
* [x] Cerrar el milestone `0.1.3` al publicar el release (y crear el siguiente si corresponde).

## 9. Documentación del release (commit/PR)

Guardar la documentación específica del release en `docs/releases/0.1.3/`.  
**No es gate de publicación** (puede mergearse antes o después del release).

* [x] Agregar:
  * [x] `docs/releases/0.1.3/release_checklist_0_1_3.md`
  * [x] `docs/releases/0.1.3/security_baseline_0_1_3.md`
  * [x] `docs/releases/0.1.3/legal_baseline_0_1_3.md`
* [x] En los 3 docs registrar: `tag v0.1.3`, `SHA commit freeze`, nombre del artefacto, `SHA256` del artefacto.
