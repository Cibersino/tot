...
Registro de este release:
artefacto ZIP de Windows x64 con `INSTALL.txt` visible en la raíz y la app colocada bajo `toT-1.5.0/toT-app/`. No se agregan assets de terceros nuevos de branding o tipografía que modifiquen la postura de redistribución.
