...
- Artefactos inspeccionados: `toT-1.5.0-linux-x86_64.AppImage`
- Hashes de artefacto: `14e6dfe0f74d71d6be665162856ac6cdfd519e4435717ec602283057c53b047d`
...
version `v1.5.0` desde `package.json`; tag esperado `v1.5.0`; commit freeze `a4ae6c1985403a3024ab9328299193dc531e1720`; plataforma objetivo Linux x86_64; artefacto inspeccionado `toT-1.5.0-linux-x86_64.AppImage`; hash `14e6dfe0f74d71d6be665162856ac6cdfd519e4435717ec602283057c53b047d`.
...
Registro requerido en este release:
El artefacto congelado ya fue generado como `toT-1.5.0-linux-x86_64.AppImage` mediante el packaging Linux x86_64 del proyecto (`npm run dist:linux` o el flujo de AppImage previsto), con `asar.smartUnpack: false` y `asarUnpack` acotado al runtime nativo esperado.
...
Registro requerido en este release:
Pendiente de creación/verificación del tag `v1.5.0` y publicación de la GitHub Release con `toT-1.5.0-linux-x86_64.AppImage`.
