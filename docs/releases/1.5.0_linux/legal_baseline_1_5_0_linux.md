...
Registro de este release:
artefacto AppImage para Linux x86_64 que entrega el mismo build empaquetado inspeccionado. No se agregan assets de terceros nuevos de branding o tipografía que modifiquen la postura de redistribución.
