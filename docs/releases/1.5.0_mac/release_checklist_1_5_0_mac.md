...
version `v1.5.0` desde `package.json`; tag esperado `v1.5.0`; commit freeze `a4ae6c1985403a3024ab9328299193dc531e1720`; plataforma objetivo macOS arm64; artefacto inspeccionado `toT-1.5.0-mac-arm64.dmg`; hash `2f49b0ffaf0dfa7224cfbf01488fccd5f72a527bae479a28412492e8910282e7`.
...
Registro requerido en este release:
El artefacto congelado ya fue generado como `toT-1.5.0-mac-arm64.dmg` mediante el packaging macOS arm64 del proyecto (`npm run dist:mac` en el protocolo normal del repo), con `target: dmg`, `asar.smartUnpack: false` y `asarUnpack` acotado al runtime nativo esperado.
...
Registro requerido en este release:
Pendiente de creación/verificación del tag `v1.5.0` y publicación de la GitHub Release con `toT-1.5.0-mac-arm64.dmg`.
