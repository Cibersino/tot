...
Fecha: `<YYYY-MM-DD>`
Tag objetivo (GitHub): `v1.1.0`
Commit freeze (Git): `<commit>`
Artefacto inspeccionado: `toT-1.1.0-win-x64.zip`
SHA256(artefacto): `<SHA>`
...
Artefacto validado: `toT-1.1.0-win-x64.zip`
