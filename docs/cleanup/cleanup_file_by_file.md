...
- En proceso (5): `electron/import_extract_platform/platform_adapters/windows.js`, `electron/import_extract_platform/platform_adapters/common.js`, `electron/import_extract_platform/platform_adapters/fallback.js`, `electron/import_extract_platform/platform_adapters/darwin.js`, `electron/import_extract_platform/platform_adapters/linux.js`.

- Archivos ya ordenados y limpiados (23): `electron/main.js`, `electron/menu_builder.js`, `public/renderer.js`, `electron/preload.js`, `public/js/import_extract_entry.js`, `electron/import_extract_platform/import_extract_prepare_execute_core.js`, `electron/import_extract_platform/import_extract_prepare_ipc.js`, `electron/import_extract_platform/import_extract_execute_prepared_ipc.js`, `electron/import_extract_platform/import_extract_preconditions_ipc.js`, `electron/import_extract_platform/import_extract_processing_mode_ipc.js`, `electron/import_extract_platform/import_extract_ocr_gate_ipc.js`, `electron/import_extract_platform/import_extract_ocr_activation_ipc.js`, `electron/import_extract_platform/import_extract_file_picker_ipc.js`, `electron/import_extract_platform/import_extract_prepared_store.js`, `electron/import_extract_platform/import_extract_platform_adapter.js`, `electron/import_extract_platform/ocr_google_drive_route.js`, `electron/import_extract_platform/ocr_google_drive_setup_validation.js`, `electron/import_extract_platform/ocr_google_drive_setup_validation_ipc.js`, `electron/import_extract_platform/ocr_google_drive_activation_state.js`, `electron/import_extract_platform/ocr_google_drive_token_storage.js`, `electron/import_extract_platform/native_extraction_route.js`, `electron/import_extract_platform/native_pdf_selectable_text_probe.js`, `electron/import_extract_platform/ocr_image_normalization.js`.

- Faltan (7): `electron/fs_storage.js`, `public/js/import_extract_status_ui.js`, `public/js/import_extract_apply_modal.js`, `public/js/import_extract_route_choice_modal.js`, `public/js/text_apply_canonical.js`, `public/js/import_extract_ocr_activation_recovery.js`, `public/js/import_extract_drag_drop.js`. 
