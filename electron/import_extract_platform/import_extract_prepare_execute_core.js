...
function buildNativePrepareFailure({
  ...
  let primaryAlertKey = 'renderer.alerts.import_extract_native_runtime_error';
  if (code === 'native_encrypted_or_password_protected') {
    primaryAlertKey = 'renderer.alerts.import_extract_native_encrypted_or_password_protected';
  } else if (code === 'unreadable_or_corrupt') {
    primaryAlertKey = 'renderer.alerts.import_extract_native_unreadable_or_corrupt';
  }
