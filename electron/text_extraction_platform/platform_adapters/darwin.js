// electron/text_extraction_platform/platform_adapters/darwin.js
'use strict';
...
function resolveDefaultPickerPath({ app, cwd, log }) {
  const documents = safeGetSystemPath(app, 'documents', log, 'text_extraction_picker.default.macos.documents');
  const home = safeGetSystemPath(app, 'home', log, 'text_extraction_picker.default.macos.home');
  return resolveExistingDirectory([documents, home], cwd, log, 'text_extraction_picker.default.macos');
}
