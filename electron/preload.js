...
const api = {
    ...
    prepareImportExtractOcrActivation: (payload) => ipcRenderer.invoke('import-extract-prepare-ocr-activation', payload),
    launchImportExtractOcrActivation: (payload) => ipcRenderer.invoke('import-extract-launch-ocr-activation', payload),
